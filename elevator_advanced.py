...
def third_floor(items):
    ...
    if "ID card" in items:
        print_pause("You use your ID card to open the door."
                "Your program manager greets you and tells you that you need to have a copy "
        ...
        if "handbook" in items:
            ...
            print_pause("They scowl when they see that you don't have your employee handbook. "
                        "They send you back to the elevator. ")
    else:
